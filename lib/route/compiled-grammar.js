...
case 1:
    /*! Production::    root : expressions EOF */
    return new yy.Root({},[yyvstack[yysp - 1]])
    break;
...
case 3:
    /*! Production::    expressions : expressions expression */
    this.$ = new yy.Concat({},[yyvstack[yysp - 1],yyvstack[yysp]]);
    break;

case 4:
    /*! Production::    expressions : expression */
case 5:
    /*! Production::    expression : optional */
    this.$ = yyvstack[yysp];
    break;

case 6:
    /*! Production::    expression : literal */
    this.$ = new yy.Literal({value: yyvstack[yysp]});
    break;

case 7:
    /*! Production::    expression : splat */
    this.$ = new yy.Splat({name: yyvstack[yysp]});
    break;

case 8:
    /*! Production::    expression : param */
    this.$ = new yy.Param({name: yyvstack[yysp]});
    break;

case 9:
    /*! Production::    optional : "(" expressions ")" */
    this.$ = new yy.Optional({},[yyvstack[yysp - 1]]);
    break;
...
case 11:
    /*! Production::    splat : SPLAT */
case 12:
    /*! Production::    param : PARAM */
    this.$ = yytext.slice(1);
    break;
